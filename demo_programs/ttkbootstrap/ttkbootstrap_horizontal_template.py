...
root.title("Stacked Frames with Navigation and Grid Layout")
...
for column in range(len(nav_buttons)):
    button_cfg = nav_buttons[column]
    ...
    if button_cfg[1]: # Add tooltip
        ToolTip(nav_button, text=button_cfg[1], delay=0)
    
    nav_button.grid(row=0, column=column, padx=0, pady=2)  # Add button to grid-layout of frame1
...
####### Add your GUI-elements in the second frame here #########
